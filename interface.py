    ...
    if st.session_state.embed_page == 'result' and st.session_state.embed_result and st.session_state.embed_result.get('success'):
        ...
        with col_left:
            ...
            <div style="font-size: 28px; color: #443C3C; line-height: 2;">
                <p style="font-weight: bold; font-size: 32px; margin-bottom: 5px;">嵌入資訊</p>
...
""", height=0)
        ...
        st.markdown('<div class="page-title-embed" style="text-align: center; margin-bottom: 5px; margin-top: -1.2rem;">嵌入機密</div>', unsafe_allow_html=True)
        ...
        with col1:
            st.markdown(f"""
            <div style="text-align: center; padding: 10px; border-bottom: 4px solid #4A6B8A; margin-bottom: 5px;">
        ...
        with col2:
            st.markdown(f"""
            <div style="text-align: center; padding: 10px; border-bottom: {'4px solid #B8C8D8' if not step1_done else '4px solid #4A6B8A'}; margin-bottom: 5px;">
        ...
        with col3:
            st.markdown(f"""
            <div style="text-align: center; padding: 10px; border-bottom: {'4px solid #B8C8D8' if not step2_done else '4px solid #4A6B8A'}; margin-bottom: 5px;">
...
""", height=0)
        ...
        with col1:
            st.markdown(f"""
            <div style="text-align: center; padding: 10px; border-bottom: 4px solid #7D5A6B; margin-bottom: 5px;">
        ...
        with col2:
            st.markdown(f"""
            <div style="text-align: center; padding: 10px; border-bottom: {'4px solid #D8C0C8' if not step1_done else '4px solid #7D5A6B'}; margin-bottom: 5px;">
